	...
	<head>
		...
		<div class="container">
			<div class="navbar-header" >
                            <a class="navbar-brand" href="admin.jsp"><img style=" margin-right: 50px;" src="tilogo.png" alt="Logo_TI" width="80px" height="75px" /></a>
			</div>
				
                    <ul class="nav navbar-nav navbar-right "  id = "mango">
                            
                        <li ><a   class="" href="admin.jsp" ><h4 style="color:white;" >HOMEPAGE</h4></a></li>
