	...
	<head>
		...
		<div class="container">
			<div class="navbar-header" >
                            <a class="navbar-brand" href="student.jsp"><img style=" margin-right: 50px;" src="tilogo.png" alt="Logo_TI" width="80px" height="75px" /></a>
			</div>
				
                    <ul class="nav navbar-nav navbar-right "  id = "mango">
                            
                        <li ><a   class="" href="student.jsp" ><h4 style="color:white;" >HOMEPAGE</h4></a></li>
                     <!--   <li ><a class="" href="#" ><h4 style="color:white;" >ABOUT US</h4></a></li>
                        <li ><a class="" href="#" ><h4 style="color:white;" >SERVICES</h4></a></li>
                        <li ><a class="" href="#" ><h4 style="color:white;" >PROJECTS</h4></a></li> -->
                  <% 
                      String sst = (String) session.getAttribute("username");
                      if(sst==null)
                      {
                      %>
